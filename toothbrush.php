...
<ul>
			<li id="1">
				<img src="TOOTHBRUSH/1.jpg" class="items" height="100" alt="" />
			...
			<li id="2">
				<img src="TOOTHBRUSH/2.png" class="items" height="100" alt="" />
			...
			<li id="3">
				<img src="TOOTHBRUSH/3.JPG" class="items" height="100" alt="" />
				
				<br clear="all" />
				<div>White Grocery Bag</div>
			</li>
			<li id="4">
				<img src="TOOTHBRUSH/4.png" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="TOOTHBRUSH/1.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="TOOTHBRUSH/2.png" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="TOOTHBRUSH/3.JPG" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="TOOTHBRUSH/4.png" class="detail_images" width="340" height="310" alt="" />
