...
$result = mysqli_query($mysqli,"SELECT `id`,`pwd`,`full_name`,`user_level` FROM users WHERE 
           $user_cond
...
$num = mysqli_num_rows($result);
  ...
  // Match row found with more than 1 results  - the user is authenticated. 
	...
	list($id,$pwd,$full_name,$user_level) = mysqli_fetch_row($result);
     ...
     // this sets session and logs user in  
      // session_start();
	   ...
	   // this sets variables in the session 
		...
		$stamp = time();
		$ckey = GenKey();
		mysqli_query($mysqli,"update users set `ctime`='$stamp', `ckey` = '$ckey' where id='$id'") or die(mysql_error());
