...
<ul>
			<li id="1">
				<img src="facewash/1.jpg" class="items" height="100" alt="" />
			...
			<li id="2">
				<img src="facewash/2.jpg" class="items" height="100" alt="" />
			...
			<li id="3">
				<img src="facewash/3.jpg" class="items" height="100" alt="" />
				
				<br clear="all" />
				<div>White Grocery Bag</div>
			</li>
			<li id="4">
				<img src="facewash/4.jpg" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="facewash/1.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="facewash/2.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="facewash/3.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="facewash/4.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<li id="5">
				<img src="facewash/5.jpg" class="items" height="100" alt="" />
			...
			<li id="6">
				<img src="facewash/6.jpg" class="items" height="100" alt="" />
			...
			<li id="7">
				<img src="facewash/7.jpg" class="items" height="100" alt="" />
				
				<br clear="all" />
				<div>WhiteGrocery Bag</div>
			</li>
			<li id="8">
				<img src="facewash/8.jpeg" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-5">
				...
				<img src="facewash/5.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-6">
				...
				<img src="facewash/6.jpg" class="detail_images" width="340" height="310" alt="" />
...
Qty <input type="text" name="product_qty" value="1" size="3" />
			...
			<div class="detail-view" id="detail-7">
				...
				<img src="facewash/7.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-8">
				...
				<img src="facewash/8.jpeg" class="detail_images" width="340" height="310" alt="" />
			...
			<li id="9">
				<img src="facewash/9.jpeg" class="items" height="100" alt="" />
			...
			<li id="10">
				<img src="facewash/10.jpg" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-9">
				...
				<img src="facewash/9.jpeg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-10">
				...
				<img src="facewash/10.jpg" class="detail_images" width="340" height="310" alt="" />
