...
<ul>
			<li id="1">
				<img src="MOUTHWASH/1.jpg" class="items" height="100" alt="" />
			...
			<li id="2">
				<img src="MOUTHWASH/2.jpg" class="items" height="100" alt="" />
			...
			<li id="3">
				<img src="MOUTHWASH/3.jpg" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="MOUTHWASH/1.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="MOUTHWASH/2.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="MOUTHWASH/3.jpg" class="detail_images" width="340" height="310" alt="" />
