...
<ul>
			<li id="1">
				<img src="grocery/OILS/1.jpg" class="items" height="100" alt="" />
			...
			<li id="2">
				<img src="grocery/OILS/2.png" class="items" height="100" alt="" />
			...
			<li id="3">
				<img src="grocery/OILS/3.jpg" class="items" height="100" alt="" />
				
				<br clear="all" />
				<div>White Grocery Bag</div>
			</li>
			<li id="4">
				<img src="grocery/OILS/4.jpeg" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="grocery/OILS/1.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="grocery/OILS/2.png" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="grocery/OILS/3.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="grocery/OILS/4.jpeg" class="detail_images" width="340" height="310" alt="" />
			...
			<li id="5">
				<img src="grocery/OILS/5.jpg" class="items" height="100" alt="" />
			...
			<li id="6">
				<img src="grocery/OILS/6.jpg" class="items" height="100" alt="" />
			...
			<li id="7">
				<img src="grocery/OILS/7.jpg" class="items" height="100" alt="" />
				
				<br clear="all" />
				<div>WhiteGrocery Bag</div>
			</li>
			<li id="8">
				<img src="grocery/OILS/8.png" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-5">
				...
				<img src="grocery/OILS/5.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-6">
				...
				<img src="grocery/OILS/6.jpg" class="detail_images" width="340" height="310" alt="" />
...
Qty <input type="text" name="product_qty" value="1" size="3" />
			...
			<div class="detail-view" id="detail-7">
				...
				<img src="grocery/OILS/7.jpg" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-8">
				...
				<img src="grocery/OILS/8.png" class="detail_images" width="340" height="310" alt="" />
			...
			<li id="9">
				<img src="grocery/OILS/9.png" class="items" height="100" alt="" />
			...
			<li id="10">
				<img src="grocery/OILS/10.png" class="items" height="100" alt="" />
			...
			<div class="detail-view" id="detail-9">
				...
				<img src="grocery/OILS/9.png" class="detail_images" width="340" height="310" alt="" />
			...
			<div class="detail-view" id="detail-10">
				...
				<img src="grocery/OILS/10.png" class="detail_images" width="340" height="310" alt="" />
